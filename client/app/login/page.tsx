...
export default function Login(){
    ...
    <h2 className={` text-center ${salsa.className} card-title mb-3`} >Log into your Unaek Account</h2>
...
<label className="input input-bordered flex items-center gap-2  mb-3">
  ...
  <input type="password" className="grow" placeholder="Password" />
      ...
      <div className="text-center">
        <p className={`text-center ${salsa.className}`}>Not a user? {<Link href='../signup' className="text-[#007F73]"> Sign up!</Link>}</p>
