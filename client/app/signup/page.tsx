...
export default function Signup(){
    return(
        <div className=" signup-container bg-[#007F73] h-screen flex items-center justify-center">
               

    <div>
        <h1 className={`text-center ${salsa.className} text-4xl text-[#ffc700] mb-10` }>Unaek Notes</h1>
        <div className="card w-96 bg-[#4ccd99] shadow-xl">
    <div className="card-body items-center text-center">
    
    <h2 className="card-title mb-3">Create a Unaek Account</h2>
